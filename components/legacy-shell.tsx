...
const links = [
  [Gauge,"Dashboard","/"],[Activity,"Live Production","/live-production"],[BarChart3,"Production Overview","/production-overview"],[Package,"Delayed & Risk","/delayed-risk"],[Activity,"Station Performance","/station-performance"],[Warehouse,"Stock Management","/stock-management"],[Truck,"Shipping","/shipping"],[Factory,"Factory Control Center","/factory-control-center"],[FileClock,"Audit Logs","/"],[UsersRound,"User Management","/"],[Settings,"Settings","/"]
] as const;
